package com.cz.live.rtmp.encoder;
...
import com.cz.live.egl.EglHelper;
import com.cz.live.egl.EglSurfaceView;
import com.cz.live.util.ByteUtil;
...
public abstract class BasePushEncoder {
    ...
    public void initEncoder(boolean isScreen, MediaProjection mediaProjection, int width, int height, int sampleRate, int channel, int sampleBit) {
        this.width = width;
        this.height = height;
        this.sampleRate = sampleRate;
        this.sampleBit = sampleBit;
...
//            }
            ...
            if (isScreen){
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                    final VirtualDisplay display = mediaProjection.createVirtualDisplay("screen-mirror", width, height,
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (outputBufferIndex == MediaCodec.INFO_OUTPUT_FORMAT_CHANGED) {
                    ...
                    Log.e("chenzhu", "sps: " + ByteUtil.bytesToHexSpaceString(encoderWeakReference.get().sps));
                    ...
                    Log.e("chenzhu", "pps: " + ByteUtil.bytesToHexSpaceString(encoderWeakReference.get().pps));
...
//                        Log.e("chenzhu", "VideoTime = " + videoBufferinfo.presentationTimeUs / 1000000.0f);
